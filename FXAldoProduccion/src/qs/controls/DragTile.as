...
package qs.controls
{
	...
	public class DragTile extends Container
	{
		...
		override protected function commitProperties():void
		{
			...
			if(renderersDirty)
			{
				...
				for(i = 0;i<_items.length;i++)
				{
					...
					///	===========
					/*renderer.toolTip = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx";
			...
			if(renderers.length > 0)
			{
				if(isNaN(_userTileHeight) || isNaN(_userTileWidth))
				{
					for(var i:int=0;i<renderers.length;i++)
					{
						...
						//UIComponent(toolTip).setStyle("horizontalAlign","xxxxxxxxxxxxxxxx")
						//toolTip.text="zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz";
						//toolTip.visible = true;
						itemRenderer.toolTip = "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa";
						//itemRenderer.setStyle("color",0xFFFFFF);
		...
		private function startReorder(e:MouseEvent):void
		{
			...
			//======================
			/*dragItem.toolTip = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx";
...
*/		public function showDragFeedback(e:DragEvent,dragAction:String = "move"):void
		...
		private function newRendererFor(item:*):IUIComponent
		{
			...
			//======================
			/*r.toolTip = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx";
			r.visible = true;
			*/
